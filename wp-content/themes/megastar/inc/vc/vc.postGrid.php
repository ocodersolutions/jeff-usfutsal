...
if (function_exists('bdthemes_post_grid')) {
	function bdthemes_post_grid_vc() {
		...
		vc_map( array(
			"name"					=> esc_html_x( "Post Grid", 'backend', 'megastar' ),
			"description"			=> esc_html_x( "Show your Post Grid Items", 'backend', 'megastar' ),
			"base"					=> "bdt_post_grid",
			'category'				=> "Post Type",
			"icon"					=> "vc-post-grid",
			"params"				=> array(
				...
				array(
					...
					"description"	=> wp_kses(_x( "If nothing is selected, it will show Items from <strong>ALL</strong> filters.", 'backend', 'megastar' ), array('strong'=>array())),
				),
				array(
					"type"			=> "dropdown",
					"class"			=> "",
					...
					"description"	=> esc_html_x( "Filter align of the post grid.", 'backend', 'megastar' ),
				),
				array(
					"type"			=> "dropdown",
					...
					"description"	=> esc_html_x( "Loading animation of the post grid.", 'backend', 'megastar' ),
				),
				array(
					"type"			=> "dropdown",
					...
					"description"	=> esc_html_x( "Filter animation of the post grid.", 'backend', 'megastar' ),
				),
				array(
			   		"type" => "number",
					...
					"value" => "10", 
					"std" => "10",
					"description" => esc_html_x( "Horizontal Gap of the post grid.", 'backend', 'megastar' ),
				),
				array(
			   		"type" => "number",
					...
					"value" => "10", 
					"std" => "10", 
					"description" => esc_html_x( "vertical Gap of the post grid.", 'backend', 'megastar' ),
				),
				array(
					"type"			=> "dropdown",
				...
				array(
					...
					"description" => esc_html_x( "Large view item of the post grid.", 'backend', 'megastar' )
				),
				array(
			   		"type" => "dropdown",
					...
					"param_name" => "medium",
					"value" => array(
						esc_html_x('1', 'backend', 'megastar' ) => "0",
						esc_html_x('2', 'backend', 'megastar' ) => "2",
						esc_html_x('3', 'backend', 'megastar' ) => "3",
						esc_html_x('4', 'backend', 'megastar' ) => "4"
					),
					"std"         => "3",
					"group"	=> esc_html_x( 'Responsive', 'backend', 'megastar' ),
					"description" => esc_html_x( "Medium view item of the post grid.", 'backend', 'megastar' )
				),
				array(
			   		"type" => "dropdown",
					...
					"std"         => "2",
					"group"	=> esc_html_x( 'Responsive', 'backend', 'megastar' ),
					"description" => esc_html_x( "Small view item of the post grid.", 'backend', 'megastar' )
				),
			)
		) );
	}
	add_action( 'vc_before_init', 'bdthemes_post_grid_vc' );
