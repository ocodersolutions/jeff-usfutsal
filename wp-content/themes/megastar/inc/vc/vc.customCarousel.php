<?php
	if (function_exists('bdthemes_custom_carousel')) {
		function bdthemes_custom_carousel_vc() {
			vc_map(
				array(
					"name"                    => esc_html_x( "Custom Carousel", 'backend', 'megastar' ),
					"base"                    => "bdt_custom_carousel",
					"icon"                    => "vc-custom-carousel",
					"category"                => "Theme Addons",
					"description"             => esc_html_x( "Describe your content as a carousel.", 'backend', 'megastar' ),
					...
					"params" => array(			
						...
						array(
							...
							'std'         => 'dark',
							'description' => esc_html_x('Style of the event carousel.', 'backend', 'megastar' ),
