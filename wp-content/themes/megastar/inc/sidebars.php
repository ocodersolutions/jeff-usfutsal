...
function megastar_widgets_init() {
	...
	if($footercolumns == '4'){
        ...
        register_sidebar(array( 'name' => esc_html__('Footer Widgets Below Logo','megastar' ), 'id' => 'footer-widgets-below-logo', 'description' => esc_html__( 'These are widgets for the Footer bewlow logo at bottom left.','megastar' ), 'before_widget' => '<div id="%1$s" class="widget %2$s"><div class="uk-panel"><div class="panel-content">', 'after_widget' => '</div></div></div>', 'before_title' => '<h3>', 'after_title' => '</h3>' ));
        register_sidebar(array( 'name' => esc_html__('Footer Widgets Open Hour','megastar' ), 'id' => 'footer-widgets-open-hour', 'description' => esc_html__( 'These are widgets for the Footer Open Hour  at bottom right.','megastar' ), 'before_widget' => '<div id="%1$s" class="widget %2$s"><div class="uk-panel"><div class="panel-content">', 'after_widget' => '</div></div></div>', 'before_title' => '<h3>', 'after_title' => '</h3>' ));
