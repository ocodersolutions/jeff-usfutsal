...
function megastar_widgets_init() {
	...
	register_sidebar(array( 'name' => esc_html__('Footer Widgets 1','megastar' ), 'id' => 'footer-widgets', 'description' => esc_html__( 'These are widgets for the Footer. You can control them from Appearance &rarr; Customize &rarr; Footer &rarr; Footer Columns.','megastar' ), 'before_widget' => '', 'after_widget' => '', 'before_title' => '<h3>', 'after_title' => '</h3>' ));
	
	if($footercolumns == '2' || $footercolumns == '3' || $footercolumns == '4'){
		register_sidebar(array( 'name' => esc_html__('Footer Widgets 2','megastar' ), 'id' => 'footer-widgets-2', 'description' => esc_html__( 'These are widgets for the Footer. You can control them from Appearance &rarr; Customize &rarr; Footer &rarr; Footer Columns.','megastar' ), 'before_widget' => '', 'after_widget' => '', 'before_title' => '<h3>', 'after_title' => '</h3>' ));
	}
	if($footercolumns == '3' || $footercolumns == '4'){
		register_sidebar(array( 'name' => esc_html__('Footer Widgets 3','megastar' ), 'id' => 'footer-widgets-3', 'description' => esc_html__( 'These are widgets for the Footer. You can control them from Appearance &rarr; Customize &rarr; Footer &rarr; Footer Columns.','megastar' ), 'before_widget' => '', 'after_widget' => '', 'before_title' => '<h3>', 'after_title' => '</h3>' ));
	}
	if($footercolumns == '4'){
		register_sidebar(array( 'name' => esc_html__('Footer Widgets 4','megastar' ), 'id' => 'footer-widgets-4', 'description' => esc_html__( 'These are widgets for the Footer. You can control them from Appearance &rarr; Customize &rarr; Footer &rarr; Footer Columns.','megastar' ), 'before_widget' => '', 'after_widget' => '', 'before_title' => '<h3>', 'after_title' => '</h3>' ));
	}
        register_sidebar(array( 'name' => esc_html__('Footer Widgets Below Logo','megastar' ), 'id' => 'footer-widgets-below-logo', 'description' => esc_html__( 'These are widgets for the Footer bewlow logo at bottom left.','megastar' ), 'before_widget' => '', 'after_widget' => '', 'before_title' => '<h3>', 'after_title' => '</h3>' ));
        register_sidebar(array( 'name' => esc_html__('Footer Widgets Open Hour','megastar' ), 'id' => 'footer-widgets-open-hour', 'description' => esc_html__( 'These are widgets for the Footer Open Hour  at bottom right.','megastar' ), 'before_widget' => '', 'after_widget' => '', 'before_title' => '<h3>', 'after_title' => '</h3>' ));
