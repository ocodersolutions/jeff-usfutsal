...
class MB_Tabs
{
	...
	{
		wp_enqueue_style( 'rwmb-tabs', MEGASTAR_MB_URL . 'meta-box-tabs/tabs.css' );
		wp_enqueue_script( 'rwmb-tabs', MEGASTAR_MB_URL . 'meta-box-tabs/tabs.js', array( 'jquery' ), '0.1', true );
	}
