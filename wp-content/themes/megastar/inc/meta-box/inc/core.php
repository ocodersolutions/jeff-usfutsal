...
class RWMB_Core
{
	...
	{
		$links[] = '<a href="'.esc_html__('https://metabox.io/docs/', 'megastar').'">' . esc_html__( 'Documentation', 'megastar' ) . '</a>';
		$links[] = '<a href="'.esc_html__('https://metabox.io/plugins/', 'megastar').'">' . esc_html__( 'Extensions', 'megastar' ) . '</a>';
		return $links;
	}
