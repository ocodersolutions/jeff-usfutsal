...
class RWMB_Select_Field extends RWMB_Choice_Field
{
	...
	public static function get_select_all_html( $field )
	{
		...
		{
			return '<div class="rwmb-select-all-none">' . esc_html__( 'Select', 'megastar' ) . ': <a data-type="all" href="#">' . esc_html__( 'All', 'megastar' ) . '</a> | <a data-type="none" href="#">' . esc_html__( 'None', 'megastar' ) . '</a></div>';
		}
		return '';
	}
}
