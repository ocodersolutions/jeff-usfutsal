	...
	public static function admin_enqueue_scripts()
	{
		...
		if ( ! $wp_scripts->get_data( 'rwmb-media', 'data' ) )
		{
			wp_localize_script( 'rwmb-media', 'i18nRwmbMedia', array(
				'add'                => apply_filters( 'rwmb_media_add_string', _x( '+ Add Media', 'media', 'megastar' ) ),
				'single'             => apply_filters( 'rwmb_media_single_files_string', _x( ' file', 'media', 'megastar' ) ),
				'multiple'           => apply_filters( 'rwmb_media_multiple_files_string', _x( ' files', 'media', 'megastar' ) ),
				'remove'             => apply_filters( 'rwmb_media_remove_string', _x( 'Remove', 'media', 'megastar' ) ),
				'edit'               => apply_filters( 'rwmb_media_edit_string', _x( 'Edit', 'media', 'megastar' ) ),
				'view'               => apply_filters( 'rwmb_media_view_string', _x( 'View', 'media', 'megastar' ) ),
				'noTitle'            => _x( 'No Title', 'media', 'megastar' ),
				'loadingUrl'         => RWMB_URL . 'img/loader.gif',
				'extensions'         => self::get_mime_extensions(),
				'select'             => _x( 'Select Files', 'media', 'megastar' ),
				'uploadInstructions' => _x( 'Drop files here to upload', 'media', 'megastar' ),
			) );
		}
	}
