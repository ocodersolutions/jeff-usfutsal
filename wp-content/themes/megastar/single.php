...
if (in_category('services', $post)) {
    ...
    <?php if ($sidebar == 'sidebar-left') { ?>
                <div class="col-sm-12 <?php echo esc_attr($sidebarlayout); ?>">
                    <aside id="tm-sidebar"   <?php echo esc_attr($sidebar); ?> <?php echo esc_attr($sidebarlayout); ?>"> 
                                ...
                                <div id="pagination" class="uk-clearfix">
                                    <ul class="uk-pagination">
                                        ...
                                        <li class="uk-pagination-next">
                                            <?php
                                            $next_btn_txt = esc_html__('Next Post', 'megastar') . ' <i class="uk-icon-arrow-right"></i>';
    ...
    ?>
                ...
                <div class="col-sm-12 <?php echo esc_attr($sidebarlayout); ?>">
                    <aside id="tm-sidebar"  <?php echo esc_attr($sidebar); ?> "> 
                <?php get_sidebar('single'); ?>
                    </aside>  <!-- end aside -->
                </div>
        <?php } ?>
