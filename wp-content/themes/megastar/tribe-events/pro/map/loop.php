...
<?php while ( have_posts() ) : the_post(); ?>
	...
	<!-- Event  -->
        <div id="post-<?php the_ID() ?>" class="<?php $event_class = tribe_events_event_classes(0,false); echo str_replace("tribe-event-featured", "tribe-event-featured1", $event_class) ?>">
		<?php
