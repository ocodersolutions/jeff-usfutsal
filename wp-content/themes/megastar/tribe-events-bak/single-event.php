...
<div id="page-wrap" class="tm-middle uk-grid" data-uk-grid-match="" data-uk-grid-margin="" >
	<div class="tm-main <?php echo esc_attr($mainlayout); ?>">
		...
		<main class="tm-content">
			...
			<div class="container">
				<div id="tribe-events-bar" class="mt-30">
							...
							<div class="tribe-bar-filters">
								<div class="tribe-bar-filters-inner tribe-clearfix">
									...
									<div class="tribe-bar-submit">
										<input class="btn btn-dark btn-theme-colored btn-flat btn-sm text-uppercase" type="submit" name="submit-bar" value="<?php printf( esc_attr__( 'Find %s', 'the-events-calendar' ), tribe_get_event_label_plural() ); ?>" />
									</div>
									<!-- .tribe-bar-submit -->
								</div>
