...
if ( $megastar_titlebar_show !== 'hide') : ?>
	...
	<?php 
		...
		$titlebar_bg_image   = '';
		$post_titlebar_style = '';
		$blog_title          = get_theme_mod('megastar_blog_title', 'Blog');
	...
	<?php if( is_object($post) && !is_archive() &&!is_search() && !is_404() && !is_author() && !is_home() && !is_page() ) { ?>
		...
		<?php if(rwmb_meta('megastar_titlebar') != 'default' && rwmb_meta('megastar_titlebar') != '') { ?>
			...
			<?php } elseif (rwmb_meta('megastar_titlebar') == 'featuredimagecenter') { ?>
						...
						<div id="tmTitleBar" class="tm-titlebar titlebar-image-center <?php echo esc_attr($titlebar_style); ?>" <?php echo esc_attr($post_titlebar_style); ?>>
							<div class="uk-container uk-container-center">
								<div class="uk-grid">
	...
	<?php } else { // If no post page ?>
		...
		<?php if($global_header == 'title') { ?>
			<div id="tmTitleBar" class="tm-titlebar titlebar-default <?php echo esc_attr($titlebar_style); ?>" <?php echo wp_kses_post($titlebar_bg_image); ?>>
				<div class="uk-container uk-container-center">
					<div class="uk-grid uk-flex-middle">
						<div  id="title" class="uk-width-medium-3-5">
							<h1><?php echo esc_html($title); ?></h1>
