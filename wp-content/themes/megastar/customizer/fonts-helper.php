 ...
 * @since Total 1.0.0
 */
function megastar_standard_fonts() {
	return apply_filters( 'megastar_standard_fonts_array', array(
 ...
 * @since 2.1.0
 */
function megastar_enqueue_google_font( $font) {
	...
	// Subset
	$subset = megastar_get_mod( 'google_font_subsets', 'latin' );
	$subset = $subset ? $subset : 'latin';
	$subset = '&amp;subset='. $subset;

	// Weights
	$weights = array( '100', '200', '300', '400', '500', '600', '700', '800', '900' );
	$weights = apply_filters( 'megastar_google_font_enqueue_weights', $weights, $font );
	$italics = apply_filters( 'megastar_google_font_enqueue_italics', true );

	// Main URL
//	$url = megastar_get_google_fonts_url() .'/css?family='. str_replace(' ', '%20', $font ) .':';
...
function megastar_get_google_fonts_url() {
	return esc_url( apply_filters( 'megastar_get_google_fonts_url', '//fonts.googleapis.com' ) );
}
function megastar_get_mod( $id, $default = '' ) {
