 ...
 */
class megastar_Customize_Frontent {
	...
	*/
	public static function customizer_css() {
		...
		echo apply_filters( 'megastar/cached_css', $cached_css );
		echo '/* WP Customizer end */';

		wp_add_inline_style( 'megastar-style', ob_get_clean() );
	}
	...
	public static function head_output() {
		...
		<meta name="theme-color" content="<?php echo get_theme_mod( 'global_link_color', '#f57c00' ); ?>">
		<meta name="msapplication-navbutton-color" content="<?php echo get_theme_mod( 'global_link_color', '#f57c00' ); ?>">
