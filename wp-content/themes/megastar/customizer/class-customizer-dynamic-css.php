 ...
 * in a way that we have a custom data type `megastar_Customizer_Dynamic_CSS` which is capable
 * of dynamically generate the CSS out from the provided array `$css_map`.
 */

if ( class_exists( 'WP_Customize_Setting' ) && ! class_exists( 'megastar_Customizer_Dynamic_CSS' ) ) {
	class megastar_Customizer_Dynamic_CSS extends WP_Customize_Setting {
		/**
